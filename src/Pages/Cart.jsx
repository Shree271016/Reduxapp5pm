...
const Cart = () => {
    ...
    const decreaseQuantity = item => e => {
        ...
        if (new_quantity <= 0) {
            Swal.fire({
                title: "Warning",
                text: "Can not decrease quantity. Remove item instead.",
                icon: "warning",
    ...
    const increaseQuantity =item => e=>{
        ...
        if(new_quantity>item.stock){
            Swal.fire({
                title:"Alert",
                text:"Maximium Quantity Reached.",
                icon: "warning"
            })
        }
        else{
    ...
    return (
        <>
            <div className='container p-5 my-5 mx-auto'>
                ...
                <table className='table table-boardered table-hover text-center align-middle'>
